...
public class QuickSort extends SortingAlgorithim {
    ...
    public void quickSort(Array array, int l, int r) {
        if (l >= r) return;
        array.switchVal(l, chooseBestThree(array,l,r));		// Note* do not necessarily need to use this method considering the input is randomized, however good practice / is essential in general inputs
